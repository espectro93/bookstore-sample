...
public record CancelOrderItemDto(String bookId, String title, String isbn, int quantity) {
    public static OrderItem toDomain(PlaceOrderItemDto dto) {
        return new OrderItem(new BookId(dto.bookId()), dto.title(), dto.isbn(), dto.quantity());
    }
}
